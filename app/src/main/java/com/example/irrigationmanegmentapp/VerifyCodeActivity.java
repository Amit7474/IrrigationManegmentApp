...
public class VerifyCodeActivity extends AppCompatActivity {
    ...
    private String mobileNumber, firstName;
    ...
    /**
     * Fill the code editText automatically
     */
    ...
    /**
     * Sends the code that the user received and gets the credential to sign-in
     * @param code
     */
                ...
                .addOnCompleteListener(VerifyCodeActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            mUserDBManager.signInToProfile(mobileNumber, firstName);
                        } else {
